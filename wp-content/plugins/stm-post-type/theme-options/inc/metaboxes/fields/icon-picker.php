...
wp_enqueue_script('consulting-icon-picker', STM_POST_TYPE_URL . 'theme-options/inc/metaboxes/components/js/icon-picker.js');

?>

<consulting_icon_picker :fields="<?php echo esc_attr($field); ?>"
...
<input type="hidden"
       ...
       v-model="<?php echo esc_attr(wp_unslash($field_value)); ?>" />