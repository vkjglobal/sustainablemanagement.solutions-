...
class Elementor_STM_Post_Tags extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Tags', 'consulting-elementor-widgets' );
	}

	public function get_icon() {
		return 'consulting-eicon-tag';
	}
	...
	protected function register_controls() {
		...
		$this->add_dimensions( '.consulting_elementor_post_tags' );
	}
	...
	protected function render() {
		if ( function_exists( 'consulting_show_template' ) ) {
			...
			$settings['css_class'] = ' consulting_elementor_post_tags';

			consulting_show_template( 'post_tags', $settings );
