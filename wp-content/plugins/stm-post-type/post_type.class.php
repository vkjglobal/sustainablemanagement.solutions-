		...
		foreach ( $fields as $key => $field ) {
			...
			switch ( $field['type'] ) {
                ...
                case 'event_timepicker':
                    ...
                    break;
				case 'iconpicker':
					if ( is_plugin_active('custom-icons-by-stylemixthemes/stm-custom-icons.php') ) {
						$icons = json_decode( file_get_contents( WP_PLUGIN_DIR . '/custom-icons-by-stylemixthemes/assets/fonts/stm/selection.json' ), true );
						foreach ( $icons['icons'] as $icon ) {
							$fonts[] = 'stm-' . $icon['properties']['name'];
						}
