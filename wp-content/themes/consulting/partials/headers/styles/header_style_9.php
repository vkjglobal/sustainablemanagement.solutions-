...
$header_copyright = consulting_theme_option( 'header_copyright', '' );
	...
	<div class="container">
		<div class="logo-box">
			<div class="logo logo-desktop">
				<?php if ( $logo ) : ?>
					<?php if ( ! empty( $header_inverse[0] ) && $dark_logo ) : ?>
		...
		<?php if ( $header_copyright ) : ?>
			<div class="header-copyright-box"><?php echo wp_kses_post( $header_copyright ); ?></div>
		<?php endif; ?>
	</div>
</div>
